# Download first 200 url in the "AweLyrics-popular music" channel playlist
# video length around 3-5 minutes
import csv
from pytube import Playlist

# Define the URL of the playlist
playlist_url = 'https://www.youtube.com/playlist?list=UULFWI1AJmkMm_sbTX_Ps8gQAw'

# Create a Playlist object
p = Playlist(playlist_url)

# Open a CSV file in write mode
with open('youtube_Vlog_urls.csv', 'w', newline='', encoding='utf-8') as csvfile:
