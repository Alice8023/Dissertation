...
# video_url = "https://www.youtube.com/watch?v=fmc0Pk8A0T0"
#
# # Define the output file path
# output_file_path = "youtube_video.mp4"
#
...
#
# print(f"Video downloaded successfully and saved as {output_file_path}")
